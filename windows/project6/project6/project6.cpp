...
const char *vert_source = "vshader6.glsl";
const char *frag_source = "fshader6.glsl";
...
void setup ( const char *data_source, const char *tga_source )
{
    ...
    glTexParameteri ( GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, tgaWidth );
    glTexParameteri ( GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, tgaWidth );
}
