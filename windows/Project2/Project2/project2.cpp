...
void init()
{
	// Change to black background for white side to be clear
...
int main( int argc, char **argv )
{
	...
	glutCreateWindow( "Guitreau Color Cube" );

	// glewExperimental = GL_TRUE; // Needed on Manjaro and Funtoo to run, else
	//	change to glutInitcontextVersion( 3, 1 );
	glewInit();
